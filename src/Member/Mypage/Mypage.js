...
const Mypage = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${url}user/interest`, {
                headers: {
                    ...
                    <div className="tabs">
                        ...
                        <div className="tabs__nav" onClick={handleTabClick}>
                            <ul className="tabs__nav-list">
                                ...
                                <li
                                    className={`tabs__nav-item ${
                                        activeTab === "like-courses" ? "js-active" : ""
                                    }`}
                                    onClick={() => setActiveTab("like-courses")}
                                >
                                    좋아요 강의
                                </li>
                                <li
                                    className={`tabs__nav-item ${
                                        activeTab === "notification-courses" ? "js-active" : ""
                                    }`}
                                    onClick={() => setActiveTab("notification-courses")}
                                >
                                    알림설정 강의
                                </li>
                            </ul>
